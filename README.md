...
Agora, dentro do IntelliJ, vamos instalar as depedências com o Maven E por fim, entre no arquivo da classe `CardapioApllication` para executar o projeto
...
<h2> API Postman </h2>
+localhost:8080/food ---- (GET)
+localhost:8080/food ---- (POST)
